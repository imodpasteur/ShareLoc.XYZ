...
for sample_dir in tqdm(samples):
    for file_path in [p['Key'] for p in fs.listdir(sample_dir)]:
        if not file_path.endswith('.smlm'): continue
...
#         print(file_path)
        ...
        if thumbnail:
            ...
            filename = './thumbnail.png'  # I assume you have a way of picking unique filenames
